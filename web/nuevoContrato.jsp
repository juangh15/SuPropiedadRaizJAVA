...
<h3>creacion de contrato para inmueble con predial:${inmueble_actual.getPredial()} </h3>
...
<c:if test="${!empty inmueble_actual}">
    <form method="POST" action="./nuevoInmueble">
        ...
        <table class="table table-bordered table-dark"
            ...
            <c:if test="${tipo_contrato=='Poner en arriendo'}">
                <tr>
                    <td>Agencia: </td>
            ...
            <c:if test="${tipo_contrato=='Poner en venta'}">
                <tr>
                    <td>Medio de pago: </td>
